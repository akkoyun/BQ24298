...
bool BQ24298::begin(void) {
	...
	// Check PMIC Version
	uint8_t _Version = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Version__);
...
bool BQ24298::Enable_Buck(void) {
	...
	// Clear Bit
	I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Input_Source__, 7, true);
...
bool BQ24298::Disable_Buck(void) {
	...
	// Set Bit
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Input_Source__, 7, true);
...
bool BQ24298::Disable_OTG(void) {
	...
	// Read Register
	uint8_t _Current_PowerOn_Config_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__);
	...
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, _PowerOn_Config_Register, true);
...
bool BQ24298::Enable_Charge(void) {
	...
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, 4, true);
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Timer_Control__, 7, true);
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 0, true);
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 1, true);
...
bool BQ24298::Disable_Charge(void) {
	...
	// Write Charge Register
	I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, _PowerOn_Config_Register, false);

	// Set Charge Termination Bit
	I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Timer_Control__, 7, true);

	// Read Curent Power On Config Register
	uint8_t _Current_Misc_Control_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__);
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, _Misc_Control_Register, false);
...
bool BQ24298::Enable_Boost_Mode(void) {
	...
	// Set OTG Config Bit
	bool _Response1 = I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, 5, true);

	// Set Charge Termination Bit
	bool _Response2 = I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Timer_Control__, 7, true);
	...
	// Write Charge Register
	bool _Response3 = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, _Misc_Control_Register | 0x08, true);
...
bool BQ24298::Disable_Boost_Mode(void) {
	...
	// Read Curent Misc Control Register
	uint8_t _Current_Power_On_Control_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__);
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, _Power_On_Control_Register | 0x10, false);
...
bool BQ24298::Disable_Charging() {
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, _PowerOn_Config_Register, false);
...
bool BQ24298::Set_Charge_Current(float _Charge_Current) {
	...
	uint8_t _Current_Data = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Current_Control__);
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Current_Control__, _Charge_Register, true);
...
bool BQ24298::Set_Charge_Voltage(float _Charge_Voltage) {
	...
	// Read Register
	uint8_t _Current_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Voltage_Control__);
	...
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Voltage_Control__, _Voltage_Register, true);
...
float BQ24298::Get_Charge_Voltage(void) {
	...
	// Read Curent Charge Register
	uint8_t _Current_Charge_Voltage_Control_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Voltage_Control__);
...
bool BQ24298::Set_Input_Current_Limit(float _Input_Current) {
	...
	// Read Curent Charge Register
	uint8_t _Input_Source_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Input_Source__);
	...
	// Write Voltage Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Input_Source__, _Current_Value | _Mask, true);
...
bool BQ24298::Set_Input_Voltage_Limit(float _Input_Voltage) {
	...
	// Write Voltage Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Input_Source__, _Voltage_Register, true);
...
bool BQ24298::Set_Minimum_System_Voltage(float _Minimum_Voltage) {
	...
	// Read Register
	uint8_t _Current_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__);
	...
	// Write Voltage Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, _Voltage_Register, true);
...
float BQ24298::Get_Minimum_System_Voltage(void) {
	...
	// Read Curent Charge Register
	uint8_t _Input_Source_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__);
...
bool BQ24298::Set_Boost_Voltage(float _Boost_Voltage) {
	...
	// Read Register
	uint8_t _Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Thermal_Control__);
	...
	// Write Voltage Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Thermal_Control__, _Register, true);
...
bool BQ24298::Set_PreCharge_Current(float _PreCharge_Current) {
	...
	// Read Curent Charge Register
	uint8_t _Current_PreCharge_Current_Control_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_PreCharge_Current_Control__);
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PreCharge_Current_Control__, _Charge_Register, false);
...
bool BQ24298::Set_TermCharge_Current(float _Term_Charge_Current) {
	...
	// Read Curent Charge Register
	uint8_t _Current_Data = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_PreCharge_Current_Control__);
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_PreCharge_Current_Control__, _Mask, true);
...
bool BQ24298::Set_Thermal_Regulation_Temperature(uint8_t _Temperature) {
	...
	// Read Curent Charge Register
	uint8_t _Current_Data = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Thermal_Control__);
	...
	// Write Charge Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Thermal_Control__, _Data, false);
...
bool BQ24298::BATFET_Disable_Bit(bool _State) {
	...
	if (!_State) _Response = I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 5, true);
	if (_State) _Response = I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 5, true);
...
bool BQ24298::Disable_DPDM() {
	...
	// Set BatFet Bit
	I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 7, true);
...
bool BQ24298::Enable_DPDM() {
	...
	// Set BatFet Bit
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 7, true);
...
bool BQ24298::Disable_BatFault_INT() {
	...
	// Set BatFet Bit
	I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 0, true);
...
bool BQ24298::ChargeFault_INT(bool _State) {
	...
	if (_State == true) {
		...
		// Set Bit
		_Response = I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 1, true);
	...
	if (_State == false) {
		...
		// Clear Bit
		_Response = I2C.Clear_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Misc_Control__, 1, true);
...
uint8_t BQ24298::Get_Charge_Fault(void) {
	...
	// Read Curent Charge Register
	uint8_t _Current_Fault_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Fault__);
...
bool BQ24298::Reset_Watchdog(void) {
	...
	// Set Bit
	I2C.Set_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_PowerOn_Config__, 6, true);
...
bool BQ24298::Set_Watchdog(uint8_t _Timer) {
	...
	// Read Curent Charge Register
	uint8_t _Current_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Timer_Control__);
	...
	// Write Voltage Register
	bool _Response = I2C.Write_Register(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Timer_Control__, _Register, true);
...
bool BQ24298::PG_STAT(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_System_Status__, 2);
...
bool BQ24298::THERM_STAT(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_System_Status__, 1);
...
bool BQ24298::DPM_STAT(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_System_Status__, 3);
...
bool BQ24298::WATCHDOG_FAULT(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Fault__, 7);
...
bool BQ24298::BAT_OVP_FAULT(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Fault__, 3);
...
bool BQ24298::VSYS_STAT(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_System_Status__, 0);
...
uint8_t BQ24298::NTC_FAULT() {
	...
	// Read Curent Charge Register
	uint8_t _Current_Data = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Fault__);
...
uint8_t BQ24298::VBUS_STAT(void) {
	...
	// Read Curent Charge Register
	uint8_t _Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_System_Status__);
...
bool BQ24298::BATLOWV(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Voltage_Control__, 1);
...
bool BQ24298::BCOLD(void) {
	...
	// Get Bit Value
	bool _Response = I2C.Read_Register_Bit(I2C.MAX17055.I2C_Address, __BQ24298_Charge_Current_Control__, 1);
...
bool BQ24298::Disable_BHOT(void) {
	...
	// Read Curent Charge Register
	uint8_t _Current_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Thermal_Control__);
...
uint8_t BQ24298::Get_Fault_Register(void) {
	...
	// Read Curent Charge Register
	uint8_t _Fault_Register = I2C.Read_Register(I2C.MAX17055.I2C_Address, __BQ24298_Fault__);
